...
const ProductCard = ({ 
  ...
  return (
    <div 
      className={cn("bg-card rounded-lg border border-border overflow-hidden shadow-sm flex flex-col h-full cursor-pointer hover:shadow-md transition-all", className)} 
    ...
    >
      <div className="relative">
        ...
        <Button 
          variant="ghost" 
          size="icon" 
          className="absolute top-2 right-2 rtl:right-auto rtl:left-2 bg-background/80 hover:bg-background rounded-full"
